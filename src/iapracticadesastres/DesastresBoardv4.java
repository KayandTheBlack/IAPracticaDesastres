 ...
 * @author Victor
 */
public class DesastresBoardv4 implements Cloneable {
  ...
  public DesastresBoardv4(ArrayList<ArrayList<ArrayList<Integer> > > travs, double t, double timeP [], double maxTimeP){
      travels = travs;
      time = t;
      timePriority = timeP;
   ...
   */
  public DesastresBoardv4(int nGrupos, int nCentros, int nHelis, int Seed) {
...
// FLIGHT WISE OPERATORS
  ...
  public DesastresBoardv4 clone() {//fixed
      ...
      DesastresBoardv4 clonedBoard = new DesastresBoardv4(travs,time, timePriority.clone(),maxTimePriority);
      return clonedBoard;
  }
