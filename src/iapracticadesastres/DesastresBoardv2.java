 ...
 * @author Victor
 */
public class DesastresBoardv2 implements Cloneable {
  ...
  public DesastresBoardv2(ArrayList<ArrayList<ArrayList<Integer> > > travs, double t){
      travels = travs;
      time = t;
  }
   ...
   */
  public DesastresBoardv2(int nGrupos, int nCentros, int nHelis, int Seed) {
